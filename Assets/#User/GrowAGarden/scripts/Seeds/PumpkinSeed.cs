...
namespace GrowAGarden
{
    public class PumpkinSeed : SeedDefinition
    {
        ...
        private void Define()
        {
            ...
            {
                new GrowthPhase { name = "vine",  duration = debug ? 10 : 60, maxScale = 1, scaleMultiplier = 1 },
                new GrowthPhase { name = "fruit", duration = debug ? 10 : 60, maxScale = 1, scaleMultiplier = 1 },
